...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2020 at 03:42 PM
...
(4, 'Isuri', 'Wijerathna', 'Dermatalogist', 'Female', 'isuri@gmail.com', '94551123454', '1500.00', 'isu123'),
(5, 'Dasuni', 'Silva', 'Psychiatrist', 'Female', 'dasuni@gmail.com', '94712278857', '2500.00', 'dasuni98'),
(7, 'Alex', 'DeSilva', 'Surgeon', 'Male', 'alex@yahoo.com', '94771234568', '4000.00', 'alex9988');
...
--
ALTER TABLE `doctor`
  MODIFY `docId` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
COMMIT;
